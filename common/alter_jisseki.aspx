<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alter_jisseki.aspx.cs" Inherits=" Jisseki_Report_Ibaraki.common.alter_jisseki" %>
...
<form id="form1" runat="server" >
    ...
    <div>
        <table>
            <tr>
                ...
                <td rowspan="3" style="width:425px; text-align:center; vertical-align:middle;">
                    <asp:Label ID="lblMsg" runat="server" Height="69px"  Width="330px" Font-Size="X-Large"  ></asp:Label>
                </td>
            </tr>
            <tr>
                <td>社　名</td>
	...
	<div id="TableDiv" >
		...
		<tr>
			...
			<td  style="background:gray;"  colspan="2"><asp:TextBox ID="txtGoukei_Kamotu2"   runat="server" class="txtTableType1"   MaxLength="3"  onfocus="select();"  onBlur="SumRow2();SumGoukei();"  BackColor="Silver"   >0</asp:TextBox></td>
		</tr>
		<tr>
